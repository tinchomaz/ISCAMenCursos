            ...
            <div class="row">
                ...
                <div class="col-md-6  textos">
                    ...
                    if ($documentacion) {
                        ...
                        $contenidohtml .= '<button onclick="descargarTodo('.$numeroModulo.')" class="btn descarga"><img src="imagenes/descarga.svg" class="iconosCursos">Descargar Archivos</button>
                                        </div>';
                    }
                    $contenidohtml .= '</div>
            </div>';
...
<script>
                ...
                if(moduloSiguiente){
                    ...
                    checkboxes.forEach(function (checkbox) {
                        ...
                        if (correcta === 'S') {
                            ...
                            imagen.src = 'imagenes/correcta.svg'; // Ajusta la ruta de la imagen correcta
                            imagen.className = 'imagenRespuesta';
                            liElement.appendChild(imagen);
                        }else{
                            var liElement = checkbox.closest('li');
                            var imagen = document.createElement('img');
                            imagen.src = 'imagenes/incorrecta.svg'; // Ajusta la ruta de la imagen correcta
                            imagen.className = 'imagenRespuesta';
                            liElement.appendChild(imagen);
                        }
                    });
    ...
    function tieneRespuestasMarcadas(idModulo) {
        var checkboxes = document.querySelectorAll('input[name=pregunta' + idModulo + ']');
